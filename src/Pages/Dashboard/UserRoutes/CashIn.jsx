...
console.log(user)
    ...
    const handleSubmit = async e => {
        ...
        if (pin.length !== 5) {
           ...
           const data = await axiosSecure.post(`/cashin`, senderData)
    ...
    return (
        <div>
            <div className="mx-auto w-full max-w-md space-y-4 rounded-lg border bg-white p-7 shadow-lg sm:p-10 dark:border-zinc-700 dark:bg-zinc-900">
                <h1 className="text-3xl font-semibold tracking-tight">Cash In</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button className="rounded-md bg-sky-500 px-4 py-2 text-white transition-colors hover:bg-sky-600 dark:bg-sky-700">Cash In</button>
                </form>
